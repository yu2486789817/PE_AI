...
public class TeachingVideoController {
    ...
    public TeachingVideoController(@Value("${file.upload-dir:./uploads}") String uploadDir) throws IOException {
    ...
    public ResponseEntity<Map<String, Object>> upload(@RequestParam("file") MultipartFile file,
        ...
        String filename = FILENAME_TIME.format(LocalDateTime.now()) + "_" + UUID.randomUUID().toString().replace("-", "").substring(0, 8) + "." + extension;
        ...
        body.put("url", buildFileUrl(request, filename));
